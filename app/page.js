    ...
    <div>
      ...
      <section className="max-w-md mx-auto mt-20 text-center border border-gray-700 rounded-xl p-8">
        ...
        <form className="flex gap-2">
          <input type="email" placeholder="Your email" className="flex-1 bg-gray-800 border border-gray-700 rounded-full px-4 py-2 text-white text-sm" />
          <button className="bg-purple-600 text-white px-6 py-2 rounded-full font-bold text-sm">Subscribe</button>
        </form>
      </section>
    </div>
  );
